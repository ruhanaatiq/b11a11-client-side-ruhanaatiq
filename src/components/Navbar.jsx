      ...
      <div className="drawer md:hidden">
        ...
        <div className="drawer-content flex items-center justify-between px-4 py-3 max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2">
            {/* ✅ Theme toggle belongs inside the header row */}
            <ThemeToggle />
            <label htmlFor="nav-drawer" className="btn btn-ghost bg-blue-600 ml-1 btn-circle">
        ...
        <div className="drawer-side z-50">
          ...
          <ul className="menu p-4 w-64 min-h-full bg-base-100 text-base-content space-y-2">
            ...
            {/* ✅ Put toggle near top (or move to bottom if you prefer) */}
